...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.endpointIsValid = endpointIsValid;\nexports.isUUIDv4 = isUUIDv4;\nexports.getUserID = getUserID;\nfunction endpointIsValid(path, hasUserID) {\n    if (hasUserID === void 0) { hasUserID = false; }\n    if (!path) {\n        return false;\n    }\n    var ckeckingPath = path[path.length - 1] === '/' ? path.slice(0, -1) : path;\n    console.log(path[path.length - 1]);\n    var urlParts = ckeckingPath.split(\"/\");\n    console.log(\"проверка\", path, ckeckingPath, urlParts);\n    console.log(hasUserID ? (urlParts === null || urlParts === void 0 ? void 0 : urlParts[1]) === \"users\" && (urlParts === null || urlParts === void 0 ? void 0 : urlParts[2]) !== '' && urlParts.length === 3 : (urlParts === null || urlParts === void 0 ? void 0 : urlParts[1]) === \"users\" && urlParts.length === 2);\n    return hasUserID ? (urlParts === null || urlParts === void 0 ? void 0 : urlParts[1]) === \"users\" && (urlParts === null || urlParts === void 0 ? void 0 : urlParts[2]) !== '' && urlParts.length === 3 : (urlParts === null || urlParts === void 0 ? void 0 : urlParts[1]) === \"users\" && urlParts.length === 2;\n}\nfunction isUUIDv4(uuid) {\n    var uuidv4Regex = /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;\n    return uuidv4Regex.test(uuid);\n}\nfunction getUserID(url) {\n    var urlParts = url === null || url === void 0 ? void 0 : url.split(\"/\");\n    var userId = urlParts === null || urlParts === void 0 ? void 0 : urlParts[2];\n    return userId;\n}\n\n\n//# sourceURL=webpack://my-webpack-project/./src/utils/inspectorsAPI.ts?");
